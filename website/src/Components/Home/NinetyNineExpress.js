...
class BiryaniMansion extends Component {
                        ...
                        <div className="owl-container-1">
                            ...
                            <div className="row slider-text justify-content-center align-items-center">
                                <div className="row justify-content-center">
                                    <div className="col-md-12 text-center heading-section">
                                    <span className="subheading">70 Percent Hospitality</span>
                                        <h2 className="mb-4">Biryani Mansion</h2>
                                    </div>
                                </div>
                            </div>
                            <section className="ftco-no-pt ftco-no-pb">
                        ...
                        <div className="owl-container-1">
                            ...
                            <div className="row slider-text justify-content-center align-items-center">
                                <div className="row justify-content-center">
                                    <div className="col-md-12 text-center heading-section">
                                        <span className="subheading">70 Percent Hospitality</span>
                                        <h2 className="mb-4">70 Percent Diet</h2>
                                    </div>
                                </div>
                            </div>
                            <section className="ftco-no-pt ftco-no-pb">
                        ...
                        <div className="owl-container-1">
                            ...
                            <div className="row slider-text justify-content-center align-items-center">
                                <div className="row justify-content-center">
                                    <div className="col-md-12 text-center heading-section">
                                        <span className="subheading">70 Percent Hospitality</span>
                                        <h2 className="mb-4">70 Percent Restro Cafe</h2>
                                    </div>
                                </div>
                            </div>
                            <section className="ftco-no-pt ftco-no-pb">
                        ...
                        <div className="owl-container-1">
                            ...
                            <div className="row slider-text justify-content-center align-items-center">
                                <div className="row justify-content-center">
                                    <div className="col-md-12 text-center heading-section">
                                        <span className="subheading">70 Percent Hospitality</span>
                                        <h2 className="mb-4">70 Percent Marinations</h2>
                                    </div>
                                </div>
                            </div>
                            <section className="ftco-no-pt ftco-no-pb">
